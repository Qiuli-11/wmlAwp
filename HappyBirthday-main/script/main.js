...
const animationTimeline = () => {
  ...
  // Modified "replay" click event to redirect to the QiXiHappy-ilovefish-master page:
  const replyBtn = document.getElementById("replay")
  replyBtn.addEventListener("click", () => {
    // Redirect to the QiXiHappy-ilovefish-master index page.
    // Adjust the relative path as necessary.
    window.location.href = "../QiXiHappy-ilovefish-master/index.html"
  })
}
